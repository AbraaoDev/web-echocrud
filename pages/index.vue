...
<template>
  <div class="grid grid-cols-[1fr_1fr] h-screen">
    <section class="py-10 px-28 flex flex-col gap-28">
      <NuxtImg src="/logo.svg" alt="Logomarca do EchoCRUD" class="w-52 h-16" />
      <div class="flex flex-col max-w-96 gap-10">
